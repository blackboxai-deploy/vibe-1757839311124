...
import { convertHtmlToMarkdown, type DocusaurusConfig } from "@/lib/html-to-markdown";
...
const ability = {
  ...
  <blockquote>
    <p><strong>Note:</strong> Remember to set appropriate cooldowns for powerful abilities to maintain game balance.</p>
  </blockquote>
  ...
  <table>
    ...
    <tbody>
      <tr><td>Attack</td><td>Deal damage to targets</td><td>Sword Strike</td></tr>
      <tr><td>Heal</td><td>Restore health points</td><td>Minor Healing</td></tr>
      <tr><td>Buff</td><td>Temporary stat increase</td><td>Strength Boost</td></tr>
    </tbody>
  </table>
</div>`;
  ...
  const convertToMarkdown = async () => {
    ...
    try {
      const result = await convertHtmlToMarkdown(htmlInput, docusaurusConfig);
